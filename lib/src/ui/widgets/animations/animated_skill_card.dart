...
class _SkillPillState extends State<SkillPill> {
  ...
  Widget build(BuildContext context) {
    ...
    borderColor = widget.isDark 
        ? const Color(0xFF00FFC8).withValues(alpha: 0.25) 
        : const Color(0xFF0891E5).withValues(alpha: 0.35);
      ...
      child: MouseRegion(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: _isActive ? dotColor.withValues(alpha: 0.6) : borderColor,
              width: _isActive ? 1.5 : 1,
            ),
            boxShadow: _isActive
                ? [
                    BoxShadow(
                      color: dotGlowColor.withValues(alpha: 0.6),
                      blurRadius: 12,
                      spreadRadius: 1,
                    ),
                    BoxShadow(
                ...
                : [
                    BoxShadow(
                      color: dotGlowColor.withValues(alpha: 0.15),
                      blurRadius: 6,
                    ),
                  ],
          ),
              ...
              AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: _isActive
                      ? [
                          BoxShadow(
                            color: dotGlowColor.withValues(alpha: 0.9),
                            blurRadius: 16,
                            spreadRadius: 2,
                          ),
                          BoxShadow(
                      ...
                      : [
                          BoxShadow(
                            color: dotGlowColor.withValues(alpha: 0.4),
                            blurRadius: 6,
                            spreadRadius: 1,
                          ),
                        ],
